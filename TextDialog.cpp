...
std::vector<std::vector<std::string>> TextDialog::historiesArray = {TextDialog::initHistory,
                                                                    TextDialog::mediumHistory,
                                                                    TextDialog::finalHistory};
...
std::vector<std::vector<std::string>> TextDialog::getHistoriesArray() {
